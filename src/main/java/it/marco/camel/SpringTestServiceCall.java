...
public class SpringTestServiceCall {
	
	public static Logger LOGGER = LoggerFactory.getLogger(SpringTestServiceCall.class);
	
	public static void main(String[] args) {
		AbstractXmlApplicationContext appContext = new ClassPathXmlApplicationContext("camel-context-service-call.xml");
		try {
